...
model_vec<-c("JiNS + Year_of_birth",
             "JiNS + Chronotype_o + Year_of_birth",
             #"JiNS + Testosterone + JiNS*Testosterone + Year_of_birth",
             "JiNS + Year_of_birth + Ethnicity_o + TDI + Alcohol + Alcintake + DaysWalked + DaysModerate + DaysVigorous  + LengthofWW_o + Job_AsthmaRisk + Job_MedRequired",
             "JiNS + Chronotype_o + Year_of_birth + Ethnicity_o + TDI + Alcohol + Alcintake + DaysWalked + DaysModerate + DaysVigorous  + LengthofWW_o + Job_AsthmaRisk + Job_MedRequired",
             ...
             "JiNS + Year_of_birth + Ethnicity_o + TDI + Alcohol + Alcintake + DaysWalked + DaysModerate + DaysVigorous  + LengthofWW_o + Job_AsthmaRisk + Job_MedRequired +Smoking_n + Packyears_nn + BMI_o + SleepDur +Sleep_med",
             ...
             "JiNS + Chronotype_o + Year_of_birth + Ethnicity_o + TDI + Alcohol + Alcintake + DaysWalked + DaysModerate + DaysVigorous  + LengthofWW_o + Job_AsthmaRisk + Job_MedRequired +Smoking_n + Packyears_nn + BMI_o + SleepDur +Sleep_med")
model_names <- c("Model 1",
                 "Model 1a: Model 1 + chronotype",
                 "Model 2",
                 "Model 2a: Model 2 + chronotype",
                 "Model 3",
                 "Model 3a: Model 3 + chronotype")
...
load(file="data/hormonequartiledata.RData")
...
sex_plots(tab7asthmadefms_men,tab7asthmadefms_men,tab7asthmadefms_women,"B.","Model 2") + guides(colour="none")  + ylab("Odds ratio of moderate-\nsevere asthma") +theme(plot.title.position = "plot")+
  sex_plots(tab7asthmadefms_men,tab7asthmadefms_men,tab7asthmadefms_women,"","Model 2a") + ggtitle("", subtitle="additionally controlled for\nchronotype") + theme(axis.text.y = element_blank(),axis.ticks.y = element_blank())+ ylab("Odds ratio of moderate-\nsevere asthma") -> p3

ggsave(filename="plots/hormones_additionallycontrolledbychrono.png",plot = p3,width=6,height=4)
